...
public class Rtu_weak  implements Serializable {
    private Long dev_id;
    ...
    public Rtu_weak(){super();}
    public Rtu_weak(Long dev_id,Long area_id,Long box_id,Integer sim_card,Long ip,Long port,String remark){
        super();
        this.dev_id=dev_id;
